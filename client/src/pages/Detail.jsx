      ...
      <div>
        <div className="w-200 flex flex-col justify-center">
                  ...
                  {data?.condition === 'New' ? (
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        src="https://www.svgrepo.com/show/376833/clipboard-plus.svg"
                      ></img>
                    ...
                    <div className="flex items-center gap-2">
                      <img
                        className="brightness-0 invert h-5"
                        src="https://www.svgrepo.com/show/376832/clipboard-minus.svg"
                      ></img>
                      <p>This product is USED</p>
                    </div>
                  )}
                </p>
              </div>
                  ...
                  {method.map((value) =>
                    value === 'Debit card' ? (
                      <div className="flex items-center">
                        <img
                          className="brightness-0 invert h-5"
                          src="https://www.svgrepo.com/show/376855/creditcard.svg"
                        />
                        <p>{value}</p>
                      </div>
                    ) : value === 'Effective' ? (
                      <div className="flex items-center">
                        <img
                          className="brightness-0 invert h-5"
                          src="https://www.svgrepo.com/show/376972/money-hand.svg"
                        />
                        <p>{value}</p>
                      </div>
                    ) : value === 'Credit card' ? (
                      <div className="flex items-center">
                        <img
                          className="brightness-0 invert h-5"
                          src="https://www.svgrepo.com/show/376974/money.svg"
                        />
                        <p>{value}</p>
                      </div>
                    ) : (
                      <div className="flex items-center">
                        <img
                          className="brightness-0 invert h-5"
                          src="https://www.svgrepo.com/show/376969/minimize.svg"
                        />
                        <p>{value}</p>
                      </div>
                    )
                ...
                <div className="flex gap-2 ml-5">
                  {data?.shipment === 'Yes' ? (
                    <div className="flex items-center gap-2 text-lime-600">
                      <img
                        className="brightness-0 invert h-5"
                        src="https://www.svgrepo.com/show/377123/airplane.svg"
                      />
                      <p>The seller makes shipments</p>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2 text-red-800">
                      <img
                        ...
                        src="https://www.svgrepo.com/show/377123/airplane.svg"
                      />
                      <p>The seller doesnt makes shipments</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="flex flex-col items-center">
            <p className="bg-gray-600 w-full text-center m-5 h-10 text-2xl font-bold p-1">
              More publications of this seller
            </p>
