    ...
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form onSubmit={sendForm} action="" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <div class="flex flex-row justify-between">
                    <div>
                        <label for="remember" class="">
                            <input onClick={() => rememberMe()} type="checkbox" id="remember" class="w-4 h-4 border-slate-200 focus:bg-indigo-600"/>
                            Remember me
                        </label>
                    </div>
                </div>
                ...
                <p class="text-center">Not registered yet? <a href="/signup" class="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
