...
import { useGetCategoryQuery } from '../features/query/CategoryQuery.jsx';
...
import { useUpdateAdMutation } from '../features/query/AdsQuery.jsx';

import swal from 'sweetalert';

export const UpdateAdvertisement = ({ ad }) => {
  const {
    id,
    category,
    title,
  ...
  const [method, setMethod] = useState(ad.method);
        ...
        <form className="space-y-3 mt-5 pb-10" onSubmit={handleSubmit}>
          ...
          <div className="flex ml-52">
            ...
            <select
              ...
              required
            >
              <option value="Active" className="w-auto basis-5/6 p-1 rounded">
                Active
              </option>
              <option value="Sold" className="w-auto basis-5/6 p-1 rounded">
                Sold
              </option>
              <option value="Paused" className="w-auto basis-5/6 p-1 rounded">
                Paused
              </option>
            </select>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <p className="font-bold hover:text-white">Update</p>
            </button>
          </div>
        </form>
      </div>
